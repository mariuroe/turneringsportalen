...
<div id="playedMatches"> </div>
   ...
   function updateStatus() {
        ...
        var columns = ["Kamp", "Kategori", "Navn1", "Navn2"];
        var columns2 = ["Kamp", "Klasse", "Motstander 1", "Motstander 2"];
        ...
        var finishedMatches = datasetText.filter(function(row) {
            var s = row["Status"];
            return s==0;
        });
